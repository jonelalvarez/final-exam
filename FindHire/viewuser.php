...
<body>
    ...
    <div class="container" style="display: flex; justify-content: center;">
        <div class="allUsers"
            style="background-color: ghostwhite; border-style: solid; border-color: gray;width: 25%; text-align: center;">
            <h1>All Users</h1>
            <ul style="display: flex; flex-direction: column; align-items: center; list-style-type: disc; padding: 0;">
                ...
                <?php foreach ($getAllUsers as $row) { ?>
                    <li style="margin-top: 10px;"><a
                            href="profile.php?user_id=<?php echo $row['user_id']; ?>"><?php echo $row['username']; ?></a>
                    </li>
                <?php } ?>
            </ul>
        </div>
