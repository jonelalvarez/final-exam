...
<body>
    ...
    <div class="centeredContainer" style="display: flex; justify-content: center; margin-top: 25px;">
        <div class="formContainer"
            style="background-color: ghostwhite; border-style: solid; border-color: gray;width: 50%; padding: 25px;">
            <?php
            ...
            <h1 style="background-color: #FFB6C1; padding: 25px; color: red;">Please take note of the admin's password
            </h1>
