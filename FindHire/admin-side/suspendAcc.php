        ...
        <div class="userInfo"
            ...
            <?php if ($getUserByID['is_suspended'] == 0) { ?>
                <form action="core/handleForms.php" method="POST">
                    ...
                    <input type="submit" value="Suspend" style="float:right; width:25%; padding:10px;"
                        name="suspendAccountBtn">
                </form>
            <?php } else { ?>
                <form action="core/handleForms.php" method="POST">
                    <input type="hidden" name="user_id" value="<?php echo $getUserByID['user_id']; ?>">
                    <input type="submit" value="Unsuspend" style="float:right; width:25%; padding:10px;"
                        name="unsuspendAccountBtn">
                </form>
            <?php } ?>
        </div>
    </div>
